...
package longrunningmicroflowupdates.actions;
 ...
 * This function is identical to "RunMicroflowAsyncInQueue", except that it takes one argument which will be passed to the microflow being called. And it doesnt create a Queue of transactions.
 * 
...
public class executeMicroflowInBackground extends CustomJavaAction<java.lang.Boolean>
{
	...
	public java.lang.Boolean executeAction() throws Exception
	{
        ...
        Core.executeAsync(c, microflow, true, contextObject);
        return true;
		// END USER CODE
	}
